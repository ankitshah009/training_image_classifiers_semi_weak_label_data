...
do
  ...
  --comment "poisson.reg=$regularize.loss=$loss_type.n=$nsample.bag=$bagsize.trial=$t.beta=$beta.lr=$lr.bs=$batchsize.ew=$entropy_weighted.blw=$binary_loss_weight.elw=$entropy_loss_weight.clw=$count_loss_weight.reuse=$reuse" \
